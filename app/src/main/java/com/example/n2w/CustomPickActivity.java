...
public class CustomPickActivity extends AppCompatActivity {
...
////    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_custom_pick);
        ArrayAdapter<String> adapter = new ArrayAdapter<>(CustomPickActivity.this, android.R.layout.simple_list_item_1, data);
